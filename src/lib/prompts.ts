...
4. Provide a the correct response based on the user's prompt, the proposed answer, and the feedback from the other models. Take into account all past proposed answers and model feedback up until the point of your review. 
